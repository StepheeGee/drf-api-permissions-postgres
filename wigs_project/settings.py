"""
Django settings for wigs_project project.
...
SECRET_KEY = 'django-insecure-az#pfov*&t_(4j2(kp_7zra1ezuj668emd%dsa#7d^^a+d2lzp'
...
ROOT_URLCONF = 'wigs_project.urls'
...
WSGI_APPLICATION = 'wigs_project.wsgi.application'
